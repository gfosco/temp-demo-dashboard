...
var RepoContributorsStats = function (_Component) {
    ...
    function RepoContributorsStats() {
        ...
        return _possibleConstructorReturn(this, (RepoContributorsStats.__proto__ || Object.getPrototypeOf(RepoContributorsStats)).apply(this, arguments));
    }

    _createClass(RepoContributorsStats, [{
        key: 'render',
        value: function render() {
            ...
            var count = void 0;
            if (apiData && !apiError && apiData.contributors.slice) {
...
RepoContributorsStats.propTypes = {
    ...
    apiData: _react.PropTypes.shape({
        contributors: _react.PropTypes.arrayOf(_react.PropTypes.object)
    }),
