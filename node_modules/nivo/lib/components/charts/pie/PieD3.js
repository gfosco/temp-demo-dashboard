...
var _PieD3Svg = require('../../../lib/charts/pie/PieD3Svg');

var _PieD3Svg2 = _interopRequireDefault(_PieD3Svg);
...
var Pie = function (_Component) {
    ...
    _createClass(Pie, [{
        ...
        value: function shouldComponentUpdate(nextProps) {
            this.pie.decorate((0, _decoratorsFromReactChildren2.default)(nextProps.children, 'decoratePie'));
        ...
        value: function componentDidMount() {
            this.pie = (0, _PieD3Svg2.default)((0, _reactDom.findDOMNode)(this));
            this.pie.decorate((0, _decoratorsFromReactChildren2.default)(this.props.children, 'decoratePie'));
