...
var Pie = function (_Component) {
    ...
    _createClass(Pie, [{
        ...
        value: function renderD3(nextProps) {
            ...
            var keyProp = nextProps.keyProp;
            var valueProp = nextProps.valueProp;
            var startAngle = nextProps.startAngle;
            var endAngle = nextProps.endAngle;
            var padAngle = nextProps.padAngle;
            var colors = nextProps.colors;
            var innerRadius = nextProps.innerRadius;
            var transitionDuration = nextProps.transitionDuration;
            var transitionEasing = nextProps.transitionEasing;
