...
var yearLegendStyles = function yearLegendStyles(_ref) {
    ...
    return years.map(function (year) {
        ...
        return {
            ...
            data: year,
            style: {
                rotation: (0, _reactMotion.spring)(rotation, { stiffness: stiffness, damping: damping }),
    ...
    return days.map(function (day) {
        return {
            ...
            style: {
                ...
                size: (0, _reactMotion.spring)(day.size, { stiffness: stiffness, damping: damping })
            }
        };
    });
};
...
var MotionCalendar = function (_Component) {
    ...
    function MotionCalendar() {
        ...
        return _possibleConstructorReturn(this, (MotionCalendar.__proto__ || Object.getPrototypeOf(MotionCalendar)).apply(this, arguments));
    }

    _createClass(MotionCalendar, [{
        key: 'render',
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    _reactMotion.TransitionMotion,
                    {
                        styles: monthLegendStyles({ months: months, direction: direction, monthLegendOffset: monthLegendOffset, stiffness: stiffness, damping: damping })
                    },
                    function (interpolatedStyles) {
                        return _react2.default.createElement(
                            'g',
                ...
                _react2.default.createElement(
                    _reactMotion.TransitionMotion,
                    {
                        styles: yearLegendStyles({ years: years, direction: direction, yearLegendOffset: yearLegendOffset, stiffness: stiffness, damping: damping })
                    },
                    function (interpolatedStyles) {
                        return _react2.default.createElement(
                            'g',
