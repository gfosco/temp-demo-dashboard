...
var Line = function (_Component) {
    ...
    _createClass(Line, [{
        ...
        value: function renderD3(props) {
            ...
            element.datum(data).transition().duration(transitionDuration).ease(transitionEasing).attr('d', line);
        }
    }, {
        ...
        value: function render() {
            return _react2.default.createElement('path', { className: 'chart__shape__line' });
        }
    }]);
